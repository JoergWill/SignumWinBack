Partial Public Class wb_sql_Selects
    ...
    Public Const sqlRohstoffLagerort = "SELECT Komponenten.KO_Nr, Komponenten.KO_Nr_AlNum, Komponenten.KO_Bezeichnung, Komponenten.KO_Type, " &
                                       "Lagerorte.LG_Ort, Lagerorte.LG_Bilanzmenge " &
    ...
    Public Const sqlUpdateLagerort = "UPDATE Lagerorte SET LG_LF_Nr = [0] WHERE LG_Ort = '[1]'"

    'Sql_statement SELECT Lagerorte nach LG_Ort
    Public Const sqlLieferungen = "Select * FROM Lieferungen WHERE LF_LG_Ort = '[0]' " &
                                  "ORDER BY Lieferungen.LF_Nr"
