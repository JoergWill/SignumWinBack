...
Public Class wb_Main_ServerConnect
    Private _TcpClient As New TcpClient
    Private _ip As String
    Private _port As String
    Private _ReConnect As Boolean = False
    ...
    <CodeAnalysis.SuppressMessage("Minor Code Smell", "S3878:Arrays should not be created for ParamArray parameters", Justification:="<Ausstehend>")>
    Private Sub DoRead(ByVal ar As IAsyncResult)
        Try
            ...
            tbMessageReceive.Invoke(New messageDelegate(AddressOf MessageRecieved), New Object() {msg})
        ...
        Catch ex As Exception
            ...
            Connect(_ip, _port, _ReConnect) 'try to reconnect
        End Try
    End Sub
        ...
        If msg.Length >= 2 Then
            Try
                ...
                Select Case msg(0) 'process it by the first element in the split array
                    ...
                    Case "CHAT"
                        'Server/Client-Chat
                        tbMessageReceive.Text &= "Server: " & " " & msg(1) & vbCrLF

                    Case "TIMR"
                        'WinBack-Aktions-Timer-Tabelle. Änderungen/Events
                        wb_Main_Shared.TimerMsg(Nothing, Mid(Message, 5))
                End Select
            Catch
            End Try
        End If
