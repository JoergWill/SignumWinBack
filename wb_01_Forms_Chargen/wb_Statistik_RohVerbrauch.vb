...
Public Class wb_Statistik_RohVerbrauch
    ...
    Private Sub wb_Statistik_RohVerbrauch_Enter(sender As Object, e As EventArgs) Handles MyBase.Enter
        'Drop-Down-Listen initialisieren
        ListeStatistik.InitGruppenListen(wb_Global.StatistikType.StatistikRohstoffeVerbrauch)
    ...
    Private Sub BerechnungStatistik(sender As Object)
        ...
        'Fenstertitel
        wb_Chargen_Shared.SetFensterTitel(wb_Global.StatistikType.StatistikRohstoffeVerbrauch)
        'Auswertung starten
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub wb_Statistik_RohVerbrauch_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
