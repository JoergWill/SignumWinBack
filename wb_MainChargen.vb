...
Public Class wb_MainChargen
    ...
    Public ReadOnly Property FormKey As String Implements IBasicFormUserControl.FormKey
        Get
            Return "@WinBackMainChargenControl"
        End Get
    End Property
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        TextBox1.Text = "Button1 gedrückt"
        Label1.Text = TimeOfDay.ToLongTimeString
        RaiseEvent Close(Me, EventArgs.Empty)
    End Sub

    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        TextBox1.Text = "Button2 gedrückt"
        Label1.Text = TimeOfDay.ToLongTimeString
        _ViewProvider.ShowOverview(sender, ObjectEnum.Articles, String.Empty, AddressOf ItemSelected)
    End Sub

    Private Sub ItemSelected(ByVal Caller As Object, ByVal ToShow As Common.ObjectEnum, ByVal SelectedItem As String, ByVal ReturnValues As DataTypes.IPropertyValuePair())
        Label1.Text = "Item selected: " & SelectedItem
    End Sub

    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        TextBox1.Text = "Artikel-Button gedrückt"
        Label1.Text = TimeOfDay.ToLongTimeString
        _ViewProvider.OpenForm(ObjectEnum.Articles, Nothing, Nothing)
    End Sub
