...
Imports WinBack.wb_KomponParam202_Global

Public Class wb_KomponParam202
    Private Structure Typ202
        Public _Wert As String
    End Structure

    Private Parameter(wb_Global.maxTyp202) As Typ202
