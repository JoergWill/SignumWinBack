...
Public Class wb_TcpIPConnection
    ...
    End Sub
    Public Event gotmessage(ByVal message As String, ByVal client As wb_TcpIPConnection)    'this is raised when we get a message from the client
    Public Event disconnected(ByVal client As wb_TcpIPConnection)    'this is raised when we get the client disconnects
