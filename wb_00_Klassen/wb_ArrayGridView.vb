...
Public Class wb_ArrayGridView
    ...
    Public Sub New(ByVal arr() As Object, Optional ShowTooltips As Boolean = True)
    ...
    Public Sub InitData(ByVal arr() As Object)
    ...
    Private Sub FillGrid(arr As Object)
