...
Public Class wb_DashRohstoff
    ...
    Private Sub wb_Dash_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Icon = WinBack.My.Resources.Resources.MainRohstoffe_64x64
    ...
    Overrides Sub wb_DashElement_Click(sender As Object, e As EventArgs)
        ...
        wb_Main_Shared.OpenForm(sender, "Rohstoffe")
    End Sub
    ...
    Public Overrides Sub StartupTimer_Tick(sender As Object, e As EventArgs)
        ...
        If winback.sqlSelect(wb_Sql_Selects.setParams(wb_Sql_Selects.sqlKompAnzahl, "> 100")) AndAlso winback.Read Then
