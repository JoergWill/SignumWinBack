...
Public Class wb_SchnittstelleT4106
    ...
    Public Overrides ReadOnly Property sql As String
        Get
            Return wb_sql_Selects.setParams(wb_sql_Selects.sqlT4106, Option_TW_Nummer)
        End Get
    End Property

    Public Overrides ReadOnly Property sqlCount As String
        Get
            Return wb_sql_Selects.setParams(wb_sql_Selects.sqlT4106_Count, Option_TW_Nummer)
        End Get
    End Property
