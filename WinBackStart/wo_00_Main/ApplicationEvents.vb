...
Namespace My
    ...
    Partial Friend Class MyApplication
        ...
        Public Shadows Event UnhandledException(sender As Object, e As UnhandledExceptionEventArgs)
        ...
        Private Function MyDomain_AssemblyResolve(ByVal sender As Object, ByVal args As System.ResolveEventArgs) As System.Reflection.Assembly Handles MyDomain.AssemblyResolve
            Dim dll_file As String = System.AppDomain.CurrentDomain.BaseDirectory & wb_Global.SubDir_dll & args.Name.Split(CChar(","))(0) & ".dll"
