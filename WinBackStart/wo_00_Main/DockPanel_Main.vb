...
Public Class DockPanel_Main
    ...
    ''' <param name="Cmd"></param>
    ''' <param name="Prm"></param>
    Public Overridable Function ExtendedCmd(Cmd As String, Prm As String) As Boolean
        Return False
    End Function
    ...
    ''' 
    ''' Wenn das Fenster (nur) versteckt ist (DockState.Hidden) wird es wieder sichtbar gemacht
    ''' 
    ''' </summary>
        ...
        For Each x As DockContent In DockPanel.Contents
            If x.Name = Name Then
                If x.DockState = DockState.Unknown Then
                    ...
                    Return False
                ElseIf x.DockState = DockState.Hidden Then
    ...
    Private Sub LoadDockBarConfig()
        ...
        If IO.File.Exists(DkPnlConfigFileName) Then
            ...
            Catch
                Trace.WriteLine("@E_Fehler beim Laden der DockPanel-Konfiguration")
            End Try
                ...
                For Each x In _DockPanelList
                    If x IsNot Nothing Then
                        ...
                        If x.DockState = DockState.Float Then
                            x.DockState = DockState.Document
                            'Dock-State Hidden oder Unknow führt zu einer Exception (vorher abfangen)
                        ElseIf (x.DockState <> DockState.Hidden) AndAlso (x.DockState <> DockState.Unknown) Then
                            Try
                                x.Show(DockPanel, x.DockState)
                            Catch
                                Trace.WriteLine("@E_Fehler beim Anzeigen Fenster " & x.Name)
                            End Try
                        End If
                    End If
                Next
    ...
    Public Overridable Sub FormOpen(Sender As Object, e As EventArgs)
    ...
    Private Sub Main_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        ...
        Dim LayoutFilename As String = wb_Functions.DkPnlConfigName(DkPnlConfigFileName, Me.Text)
    ...
    Public Overridable Sub FormClose(Sender As Object, e As FormClosedEventArgs)
