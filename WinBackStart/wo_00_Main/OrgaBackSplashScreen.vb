Public NotInheritable Class OrgaBackSplashScreen
    ...
    Private Sub OrgaBackSplashScreen_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Version.Text = "Version " & wb_GlobalSettings.WinBackVersion
