...
Public Class Schnittstelle_Main
    ...
    Public SchnittstelleVorschau As wb_Schnittstelle_KonfigVorschau 'Detail-Fenster     (wird bei Bedarf erzeugt und angezeigt)
    ...
    Public Overrides Function ExtendedCmd(Cmd As String, Prm As String) As Boolean
        Select Case Cmd
            ...
            Case "SCHNITTST_VORSCHAU"
                If IsNothingOrDisposed(SchnittstelleVorschau) Then
                    SchnittstelleVorschau = New wb_Schnittstelle_KonfigVorschau
                End If
                SchnittstelleVorschau.Show(DockPanel)
                Return True
    ...
    Public Overrides Function wbBuildDocContent(ByVal persistString As String) As WeifenLuo.WinFormsUI.Docking.DockContent
        Select Case persistString
            ...
            Case "WinBack.wb_Schnittstelle_KonfigVorschau"
                SchnittstelleVorschau = New wb_Schnittstelle_KonfigVorschau
                _DockPanelList.Add(SchnittstelleVorschau)
                Return SchnittstelleVorschau
    ...
    Public Overrides Sub FormClose(Sender As Object, e As FormClosedEventArgs)
        ...
        wb_Functions.CloseAndDisposeSubForm(SchnittstelleVorschau)
    End Sub
End Class