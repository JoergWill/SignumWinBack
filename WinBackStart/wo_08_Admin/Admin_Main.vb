...
Public Class Admin_Main
    ...
    Public AdminDatensicherung As wb_Admin_Datensicherung         'Default-Fenster    (wird beim Öffnen NICHT immer angezeigt)
    ...
    Public AdminEditIniMaster As wb_Admin_EditIni                 'Detail-Fenster     (wird bei Bedarf erzeugt und angezeigt)
    ...
    Public AdminXNumber As wb_Admin_XNumber                       'Detail-Fenster     (wird bei Bedarf erzeugt und angezeigt)
    ...
    Public Overrides Function ExtendedCmd(Cmd As String, Prm As String) As Boolean
        Select Case Cmd
            ...
            Case "EDITKONFIG"
                ...
                Return True
            Case "EDITKONFIGMASTER"
                If IsNothingOrDisposed(AdminEditIniMaster) Then
                    AdminEditIniMaster = New wb_Admin_EditIni With {.MasterIniFile = True}
                End If
                AdminEditIniMaster.Show(DockPanel)
                Return True
            Case "CHECKDATABASE"
    ...
    Public Overrides Sub FormClose(Sender As Object, e As FormClosedEventArgs)
        ...
        wb_Functions.CloseAndDisposeSubForm(AdminXNumber)
    End Sub
End Class